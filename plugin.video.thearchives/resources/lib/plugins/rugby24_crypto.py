"""Self-contained AES-GCM support used only by the Rugby24 Byse resolver."""
...
if _AES:
    ...
    def aes_gcm_decrypt_and_verify_bytes(data, key, tag, nonce):
        ...
        return _AES.new(key, _AES.MODE_GCM, nonce).decrypt_and_verify(data, tag)
...
def aes_gcm_decrypt_and_verify(data, key, tag, nonce):
    ...
    s_tag = ghash(
        hash_subkey,
        data
        + [0] * (-len(data) % BLOCK_SIZE_BYTES)                 # pad
